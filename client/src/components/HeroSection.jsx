...
const HeroSection = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 mf:px-16 lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <div className='flex items-center gap-1 '>
            <Calendar className='size-4.5' />2018
        </div>
        <div className='flex items-center gap-1 '>
            <Clock className='size-4.5' />2h 8m
        </div>
        </div>
